...
public class TestInvertedHash {
	...
	static Stats checkIndex(BioGraph[] bgs, HashedInvertedIndex invInd) {
	...
	throws NumberFormatException 
	{
		...
		if (args.length >= 3) {
			tolerance = Integer.parseInt(args[2]);
		}

		HashedInvertedIndex invInd = new HashedInvertedIndex();
